                        ...
                        <center>
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <img src="/{{ Topbar()->image }}" style="width:36px;padding:4px"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <center>
                                <div class="col-xl-3 col-md-6 wow fadeInUp" style="width: 1000px"
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <div class="icerik">
                                            <p class="footer-text" style="width:630px"><span
                                        ...
                                        <ul class="footer-social mt-3 gap-2" style="justify-content: center">
                                            @if (SocialMedia())
