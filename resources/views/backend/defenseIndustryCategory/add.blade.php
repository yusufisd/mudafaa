                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 fv-row">
                                                                <input type="file" name="image"
                                                                    required class="form-control form-control-lg  mb-3 mb-lg-0"
                                                                    value="" />
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
                                                    ...
                                                    <div class="card-body px-3 py-9">
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <div class="col-lg-10 fv-row">
                                                                <textarea name="seo_description_tr" id="seo_description_tr" required class="form-control form-control-lg form-control-solid"
                                                                    value=""></textarea>
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
