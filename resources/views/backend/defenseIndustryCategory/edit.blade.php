...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <!--end::Toolbar-->
        <!--begin::Content-->
        <form action="{{ route('admin.defenseIndustryCategory.update',$data_tr->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 fv-row">
                                                                <select name="category" aria-label="Seçiniz"
                                                                    ...
                                                                    @foreach ($cats as $cat)
                                                                        <option {{$data_tr->defense_id == $cat->id ? 'selected' : ''}} value="{{ $cat->id }}">
                                                                            {{ $cat->title }}
                                                                        </option>
                                                                    @endforeach
                                                        ...
                                                        <div class="tab-pane fade" id="tab_blog_category_detail_en"
                                                            ...
                                                            <div class="card-body px-0 py-9">
                                                                ...
                                                                <div class="row mb-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="col-lg-2 col-form-label ps-5 required fw-bold fs-6"> {{__('message.başlık')}} </label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-10">
                                                                        <!--begin::Row-->
