                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <select name="category" aria-label="Seçiniz"
                                                            ...
                                                            @foreach ($categories as $cat)
                                                                <option @selected(old('category') == $cat->id) value="{{ $cat->id }}"> {{ $cat->title }}
                                                                </option>
                                                            @endforeach
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-6 fv-row fv-plugins-icon-container ps-5">
                                                        <div class="row">
                                                            <!--begin::Label-->
                                                            <label
                                                                class="col-lg-4 col-form-label required fw-bold fs-6">Yazar</label>
                                                            <!--end::Label-->
                                                            <!--begin::Col-->
                                                            <div class="col-lg-8">
                                                                <!--begin::Row-->
                                                        ...
                                                        <div class="tab-pane fade show active" id="tab_activity_tr"
                                                            ...
                                                            <div class="card-body px-0 py-9">
                                                                ...
                                                                <div class="row mb-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="col-lg-2 required col-form-label ps-5 fw-bold fs-6">İçerik</label><br>
                                                                    <!--end::Label-->
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-10 fv-row">
                                                                        <textarea  name="description_tr" id="editor"
                                                                            class="form-control form-control-lg form-control-solid" value="">{{ old('description_tr') }}</textarea>
                                                                    </div>
                                                                    <!--end::Col-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                ...
                                                                <div class="row mb-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="col-lg-2 col-form-label required ps-5 fw-bold fs-6">Youtube</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-10">
                                                                        <!--begin::Row-->
                                                        ...
                                                        <div class="tab-pane fade" id="tab_activity_en" role="tabpanel">
                                                            ...
                                                            <div class="card-body px-0 py-9">
                                                                ...
                                                                <div class="row mb-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="col-lg-2 col-form-label ps-5 fw-bold fs-6 required">İçerik</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-10 fv-row">
                                                                        <textarea  name="description_en" id="editor2"
                                                                            class="form-control form-control-lg form-control-solid" value="">{{ old('description_en') }}</textarea>
                                                                    </div>
                                                                    <!--end::Col-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                ...
                                                                <div class="row mb-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="col-lg-2 col-form-label ps-5 fw-bold required fs-6">Youtube</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-10">
                                                                        <!--begin::Row-->
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <div class="col-lg-10 fv-row">
                                                                <textarea  name="seo_description_tr" id="seo_description_tr"
                                                                    class="form-control form-control-lg form-control-solid" value="">{{ old('seo_description_tr') }}</textarea>
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <div class="col-lg-10 fv-row">
                                                                <textarea  name="seo_description_en" id="seo_description_en"
                                                                    class="form-control form-control-lg form-control-solid" value="">{{ old('seo_description_en') }}</textarea>
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
                                                        <!--end::Input group-->
