...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <form action="{{ route('admin.videoCategory.update',$data_tr->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <div class="tab-pane fade show active" id="tab_blog_detay" role="tabpanel">
                                            ...
                                            <div class="card-body px-3 py-9">
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label
                                                        class="col-lg-2 col-form-label ps-5 required fw-bold fs-6">Sıralama</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                        <!--begin::Row-->
                                                                    ...
                                                                    <div class="col-lg-4 d-flex align-items-center">
                                                                        <div
                                                                            ...
                                                                            <input class="form-check-input w-50px h-25px"
                                                                                ...
                                                                                {{$data_en->status == 1 ? 'checked' : ''}} name="status_en" />
                                                                            <label class="form-check-label"
