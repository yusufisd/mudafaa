...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <form action="{{ route('admin.cooperationPageEdit.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
                                                            ...
                                                            <div class="card-body px-0 py-9">
                                                                ...
                                                                <div class="row mb-6">
                                                                    ...
                                                                    <div class="col-lg-10 fv-row">
                                                                        <textarea name="description_tr" id="editor" class="form-control form-control-lg form-control-solid" value=""> {{ $data->description ?? '' }} </textarea>
                                                                    </div>
                                                                    <!--end::Col-->
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="tab-pane fade" id="tab_activity_en" role="tabpanel">
                                                            ...
                                                            <div class="card-body px-0 py-9">
                                                                ...
                                                                <div class="row mb-6">
                                                                    ...
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-10 fv-row">
                                                                        <textarea name="description_en" id="editor2" class="form-control form-control-lg form-control-solid"
