                    ...
                    <div id="kt_app_footer" class="app-footer">
                        ...
                        <div
                            ...
                            <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                                <li class="menu-item">
                                    <a href="https://gaviaworks.com/hakkimizda" target="_blank"
                                        class="menu-link px-2">Hakkımızda</a>
                                </li>
                                <li class="menu-item">
                                    <a href="https://gaviaworks.com/iletisim" target="_blank"
                                        class="menu-link px-2">İletişim</a>
                                </li>
