                                ...
                                <div class="card-body py-5">
                                    ...
                                    <form method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="container" style="border: solid; padding:15px; border-radius:5px;border-color:lightgray">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="checkbox" {{ is_adsense(request()->id,42) == 1 ? 'checked' : '' }} value="42" name="reklam[]" id="42">&nbsp;&nbsp;
                                                    <label for="42">Üst Kısım (728x90)</label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="checkbox" {{ is_adsense(request()->id,43) == 1 ? 'checked' : '' }} value="43" name="reklam[]" id="43">&nbsp;&nbsp;
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="checkbox" {{ is_adsense(request()->id,44) == 1 ? 'checked' : '' }} value="44" name="reklam[]" id="44">&nbsp;&nbsp;
                                                    <label for="44">Alt Kısım (1320x90)</label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="checkbox" {{ is_adsense(request()->id,45) == 1 ? 'checked' : '' }} value="45" name="reklam[]" id="45">&nbsp;&nbsp;
