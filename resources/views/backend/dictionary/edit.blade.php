...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <form action="{{ route('admin.dictionary.update', $data_tr->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                                            ...
                                            <div class="card-body px-3 py-9">
                                                ...
                                                <div style="text-align: center">
                                                    <img src="/{{ $data_tr->image }}"
                                                        style="width: 300px; border-radius:15px; margin-bottom:3%" alt="">
                                                </div>
                                                <!--begin::Input group-->
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                        ...
                                                        <div class="card-body px-0 py-9">
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <div class="col-lg-11 fv-row mb-5 ps-5">
                                                                    ...
                                                                    <textarea id="tinymce_activity_detail_tr" name="short_description_tr" class="tox-target">{{ $data_tr->description }}</textarea>
                                                        ...
                                                        <div class="card-body px-0 py-9">
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <div class="col-lg-11 fv-row mb-5 ps-5">
                                                                    ...
                                                                    <textarea id="tinymce_activity_detail_en" name="short_description_en" class="tox-target">{{ $data_en->description }}</textarea>
