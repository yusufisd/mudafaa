                    ...
                    <div class="col-xl-2">
                        ...
                        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="fw-bold fs-2 mb-2 mt-5 text-gray-900"> {{ $currentNewsCount }} </div>
                                <div class="fw-semibold text-gray-400">Haber</div>
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-2">
                        ...
                        <a href="#" class="card bg-success hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="fw-bold fs-2 mb-2 mt-5 text-gray-100"> {{ $defenseIndustryCount }} </div>
                                <div class="fw-semibold text-gray-100">SS Ürün</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-2">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="fw-bold fs-2 mb-2 mt-5 text-white"> {{ $activityCount }} </div>
                                <div class="fw-semibold text-white">Etkinlik</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-2">
                        ...
                        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="fw-bold fs-2 mb-2 mt-5 text-gray-900"> {{ $dictionaryCount }} </div>
                                <div class="fw-semibold text-gray-400">Sözlük</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-2">
                        ...
                        <a href="#" class="card bg-success hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="fw-bold fs-2 mb-2 mt-5 text-gray-100"> {{ $videoCount }} </div>
                                <div class="fw-semibold text-gray-100">Video</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-2">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="fw-bold fs-2 mb-2 mt-5 text-white"> {{ $companyCount }} </div>
                                <div class="fw-semibold text-white">Firma</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
