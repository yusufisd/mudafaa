                                            ...
                                            <div class="card-body px-3 py-9">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <label class="col-lg-2 col-form-label ps-5 fw-bold fs-6">
                                                        {{ __('message.kapak') }} {{ __('message.görsel') }} (1920px - 2880px) </label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10 fv-row">
                                                        <select name="countries[]" aria-label="Seçiniz" data-control="select2"
                                                            data-placeholder="Seçiniz..."
                                                            class="form-select form-select-solid form-select-lg fw-semibold"
                                                            multiple>
                                                            <option value="">Seçiniz...</option>
                                                        ...
                                                        <div class="col-lg-4 d-flex align-items-center">
                                                            <div
                                                                ...
                                                                <input class="form-check-input w-50px h-25px"
                                                                    type="checkbox" id="allowblog_detail_tr" name="national"
                                                                    checked="checked">
                                                                ...
                                                                <div class="row mb-0">
                                                                    ...
                                                                    <div class="col-lg-4 d-flex align-items-center">
                                                                        <div
                                                                            class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                                            <input class="form-check-input w-50px h-25px"
                                                                                type="checkbox" id="allowblog_detail_en" name="status_en"
                                                                                checked="checked" />
                                                                            <label class="form-check-label"
