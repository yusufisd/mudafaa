                                            ...
                                            <div class="card-body px-3 py-9">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <label class="col-lg-2 col-form-label ps-5 fw-bold fs-6">
                                                        {{ __('message.kapak') }} {{ __('message.görsel') }} (1920px -
                                                        2880px) </label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <select name="category[]" aria-label="Seçiniz"
                                                            ...
                                                            @foreach ($categories as $item)
                                                                <option
                                                                    {{ in_array($item->id, $data_tr->category) != false ? 'selected' : '' }}
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <select name="author" aria-label="Seçiniz"
                                                            ...
                                                            @foreach ($users as $item)
                                                                <option {{ $data_tr->author == $item->id ? 'selected' : '' }}
                                                                    value="{{ $item->id }}"> {{ $item->name }}
                                                                </option>
                                                            @endforeach
