            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                    ...
                    <h1 class="page-heading d-flex text-primary fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ __('message.savunma') }} {{ __('message.sanayi') }} {{ __('message.kategori') }}
                ...
                <div class="gap-5" style="display: flex" style="text-align: right!important">
                    <div id="goster" class="col-md-8" style="display:none">
                        <form action="{{ route('admin.defenseIndustry.ice_aktar') }}" method="POST"
                    ...
                    <div>
                        <a href="{{ route('admin.defenseIndustry.disa_aktar') }}">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        ...
                                        <a type="button" class="btn btn-outline btn-outline-success"
                                            href="{{ route('admin.defenseIndustry.add') }}">
