                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <div class="row">
                                                            <!--begin::Col-->
                                                            <div class="col-lg-12 fv-row">
                                                                <input required type="text" name="color_code"
                                                                    class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                    value="" />
                                                            </div>
                                                            <!--end::Col-->
                                                ...
                                                <div class="tab-pane fade" id="tab_blog_category_seo_en" role="tabpanel">
                                                    ...
                                                    <div class="card-body px-3 py-9">
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <!--begin::Col-->
                                                            <div class="col-lg-10 fv-row">
                                                                <textarea required name="seo_descriptipn_en" id="seo_description_en" class="form-control form-control-lg form-control-solid"
                                                                    value=""></textarea>
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
