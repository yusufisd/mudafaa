            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-primary fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ __('message.etkinlik') }} {{ __('message.kategorisi') }}
                        {{ __('message.ekle') }}</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <div class="row">
                                                            <!--begin::Col-->
                                                            <div class="col-lg-12 fv-row">
                                                                <input  type="text" name="color_code" placeholder="#236500"
                                                                    class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <div class="col-lg-10">
                                                                ...
                                                                <div class="row">
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-12 fv-row">
                                                                        <input type="text" required name="seo_key_tr[]"
                                                                            id="seo_key_tr"
                                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                            value="" />
                                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="tab_blog_category_seo_en" role="tabpanel">
                                                    ...
                                                    <div class="card-body px-3 py-9">
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <!--begin::Col-->
                                                            <div class="col-lg-10 fv-row">
                                                                <textarea required name="seo_description_en" id="seo_description_en" class="form-control form-control-lg form-control-solid"
