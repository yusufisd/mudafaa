                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        <a type="button" class="btn btn-outline btn-outline-success"
                                            href="{{ route('admin.titleIcon.add') }}">
                                            <i class="fa-solid fa-plus"></i> İkon & Başlık
                                            {{ __('message.ekle') }}
                                        </a>
                                    ...
                                    <table id="blog_management_table" class="table gy-7 gx-7">
                                        <thead>
                                            <tr class="fw-bold fs-6 text-gray-800">
                                                ...
                                                <th style="text-align: center">İkon<i class="fa fa-sort ms-3"></i></th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $item)
                                                <tr class="align-middle">
                                                    ...
                                                    <td style="text-align: center"> {!! $item->icon_tr !!}</td>
                                                    <td style="text-align: center"> {{ $item->title_tr }}</td>
                                                    <td style="text-align: center"> {{ $item->created_at->format('d-m-Y') }} </td>
                                                    
                                                    
                                                    <td style="text-align: center" class="text-center">
                                                        <a href="{{ route('admin.titleIcon.edit', $item->id) }}"
        ...
        function destroy(d) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.titleIcon.destroy') }}/" + d;
                }
            })
        }
