                                    ...
                                    <div class="tab-content" id="TabContent_1">
                                        <div class="tab-pane fade show active" id="tab_blog_category_detay" role="tabpanel">
                                            ...
                                            <div class="card-body px-3 py-9">
                                                ...
                                                <div style="text-align: center; margin-bottom:3%">
                                                    <img src="/{{$data_tr->image}}" style="width: 300px; border-radius:15px" alt="">
                                                </div>
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <select name="category" aria-label="Seçiniz" data-control="select2"
                                                            ...
                                                            @foreach ($categories as $item)
                                                                <option {{$data_tr->category == $item->id ? 'selected' : ''}} value="{{ $item->id }}"> {{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4 d-flex align-items-center">
                                                                        <div
                                                                            ...
                                                                            <input class="form-check-input w-50px h-25px"
                                                                                type="checkbox" name="status_tr" {{$data_tr->status == 1 ? 'checked' : ''}}
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="row mb-0">
                                                                    ...
                                                                    <div class="col-lg-4 d-flex align-items-center">
                                                                        <div
                                                                            class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                                            <input name="status_en" {{$data_en->status == 1 ? 'checked' : ''}}
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="col-lg-11 fv-row">
                                                            <input type="text" placeholder="İkon"
                                                                ...
                                                                name="company_icon[]" value="{{$item->icon}}" id="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="col-lg-11 fv-row">
                                                            <input type="text" placeholder="Başlık"
                                                                class="form-control form-control-lg form-control-solid mb-lg-0 mb-3"
                                                                name="company_title[]"  value="{{$item->title}}" id="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="col-lg-11 fv-row">
                                                            <input type="text" placeholder="Açıklama"
                                                                class="form-control form-control-lg form-control-solid mb-lg-0 mb-3"
                                                                name="company_description[]"  value="{{$item->description}}" id="">
                                                        </div>
                                                    </div>

                                                    <div class="col-md-1" style="padding-left:1px" >
                                                        <button style="width:80px" class="btn btn-danger delete_item_buton ">SİL</button>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade container" id="gorseller" role="tabpanel"><br>
                                            ...
                                            <div class="row" style="padding: 1%" id="show_item3">
                                                <div class="col-md-2" style="text-align:center">
                                                    <img src="/{{$item->image}}" style="width: 100px; border-radius:15px" alt="">
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="col-lg-11 fv-row">
                                                        <input type="file"
                                                ...
                                                <div class="col-md-2">
                                                    <div class="col-lg-11 fv-row">
                                                        <input type="number" placeholder="Sıralama"
                                                            class="form-control form-control-lg form-control-solid mb-lg-0 mb-3"
                                                            name="gorseller_queue[]" value="{{$item->queue}}" id="">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="tab-pane fade container" id="adresler" role="tabpanel"><br>
                                            @foreach ($adresler as $item)
                                                <div id="show_item2" style="margin-bottom:3%">
                                                    <div
                                                        style="border:solid; padding:2%; border-color:lightgray; border-radius:15px">
                                                        <div class="row mb-6">
                                                            <!--begin::Label-->
                                                            <label class="col-lg-2 col-form-label fw-bold fs-6 ps-5">
                                                            ...
                                                            <div class="col-lg-10 fv-row">
                                                                <input type="text"
                                                                    class="form-control form-control-lg form-control-solid mb-lg-0 mb-3"
                                                                    name="address_title[]" value="{{ $item->title }}"
                                                                    id="">
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <div class="col-lg-10 fv-row">
                                                                <input type="text"
                                                                    class="form-control form-control-lg form-control-solid mb-lg-0 mb-3"
                                                                    name="address_address[]" value="{{ $item->address }}"
                                                                    id="">
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
            ...
            $(".add_item_buton2").click(function(e) {
                ...
                $("#show_item2").prepend('<div id="show_item2" class="pb-20">\
                                                    <div  style="border:solid; padding:2%; border-color:lightgray; border-radius:15px">\
                                                        ...
                                                        <div style="text-align: center" class="py-6">\
                                                            <button style="width:80px" type="button" class="btn btn-danger delete_item_buton2">SİL</button>\
                                                        </div>\
                                                    </div>\
                                                </div>');
            });
