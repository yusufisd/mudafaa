...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <form action="{{ route('admin.topbar.update',$data_tr->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                                    ...
                                    <div class="tab-content" id="TabContent_1">
                                        <div class="tab-pane fade show active" id="tab_blog_detay" role="tabpanel">
                                            ...
                                            <div class="card-body px-3 py-9">
                                                ...
                                                <div class="center" style="text-align: center; padding:5%">
                                                    <img src="/{{ $data_tr->image }}" style="width: 50px;border-radius:5px" alt="">
                                                </div>
                                                <!--begin::Input group-->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row mb-6">
                                                            ...
                                                            <div class="col-lg-8">
                                                                ...
                                                                <input type="color" value="{{ $data_tr->color_code }}" class="form-control" style="height: 40px" name="color_code" id="">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input required type="date" name="start"
                                                                        ...
                                                                        value="{{ $data_tr->start_time->format('Y-m-d') }}" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input required type="date" name="finish"
                                                                        class="form-control form-control-lg form-control-solid mb-lg-0 mb-3"
                                                                        value="{{ $data_tr->finish_time->format('Y-m-d') }}" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
