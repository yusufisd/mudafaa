                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        <a type="button" class="btn btn-outline btn-outline-success"
                                            href="{{ route('admin.companyIcon.add') }}">
                                            <i class="fa-solid fa-plus"></i>  İkon
                                            {{ __('message.ekle') }}
                                        </a>
                                            ...
                                            @foreach ($data as $item)
                                                <tr class="align-middle">
                                                    ...
                                                    <td style="text-align: center" class="text-center">
                                                        <a href="{{ route('admin.companyIcon.edit', $item->id) }}"
        ...
        function destroy(d) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.companyIcon.destroy') }}/" + d;
                }
            })
        }
