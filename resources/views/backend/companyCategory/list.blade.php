        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-10">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="gap-5" style="display: flex" style="text-align: right!important">
                    ...
                    <div>
                        <a href="{{ route('admin.companyCategory.disa_aktar') }}">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        <a type="button" class="btn btn-outline btn-outline-success"
                                            href="{{ route('admin.companyCategory.add') }}">
                                            <i class="fa-solid fa-plus"></i> Firma {{ __('message.kategorisi') }} 
                                            {{ __('message.ekle') }}
                                        </a>
                                            ...
                                            @foreach ($data as $item)
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="{{ route('admin.companyCategory.edit', $item->id) }}"
